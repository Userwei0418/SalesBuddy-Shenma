...
ClaimDirectoryStatus = Literal["unclaimed", "claimed", "mine", "pending", "legacy_review"]


class DirectoryFilterOption(BaseModel):
    value: str
    label: str


class CustomerDirectoryOptions(BaseModel):
    industries: list[DirectoryFilterOption]
    claim_statuses: list[DirectoryFilterOption]
