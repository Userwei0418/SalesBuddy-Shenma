"""Canonical current visit fields. Historical DB form snapshots remain immutable.

After changing this contract, allocate a NEW form version and generate a forward
migration with scripts/export_visit_contract.py. Never edit an applied snapshot.
"""

from dataclasses import asdict, dataclass
from uuid import UUID, uuid5

CONTRACT_VERSION = "visit.v3"
FORM_VERSION_ID = "31000000-0000-0000-0000-000000000042"
FORM_DEFINITION_ID = "30000000-0000-0000-0000-000000000001"
FIELD_VERSION = 42
MIN_EXCLUSIVE_SCORE = 60
...
def schema_snapshot():
    return {
        ...
        "threshold": {"operator": ">", "value": MIN_EXCLUSIVE_SCORE},
        "fields": [{**asdict(f), "id": str(uuid5(UUID(FORM_VERSION_ID), f.field_key))} for f in FIELDS],
    }
